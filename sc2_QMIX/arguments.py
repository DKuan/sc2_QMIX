...
def parse_args():
    ...
    parser.add_argument("--max_episode", type=int, default=45, help="maximum episode length")
    # parser.add_argument("--num-adversaries", type=int, default=1, help="number of adversaries")

    # core training parameters
    parser.add_argument("--device", default=device, help="torch device ")
    parser.add_argument("--learning_start_step", type=int, default=1000, help="learning start steps")
    ...
    parser.add_argument("--mix_net_out", type=list, default=[64, 64], help="size of layers feature in q_net")
    parser.add_argument("--q_net_hidden_size", type=list, default=64, help="size of hidden feature in q_net")
    parser.add_argument("--hyper_par", type=dict, default={'w1':3, 'w2':4, 'b1':3, 'b2':4}, \
            help="size of hidden feature in q_net")
