...
def parse_args():
    ...
    parser.add_argument("--anneal_par", type=float, default=0.999991, help="learning frequency")
    ...
    parser.add_argument("--learning_start_episode", type=int, default=1700, help="learning start episode")
    ...
    # checkpointing
    parser.add_argument("--fre4save_model", type=int, default=4250)
    ...
    parser.add_argument("--start_save_model", type=int, default=5000, help="saving the model")
    parser.add_argument("--save_dir", type=str, default="models", help="model should be saved")
    parser.add_argument("--old_model_name", type=str, default="models/1912_131633/", help="model are loaded")
