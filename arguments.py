...
def parse_args():
    ...
    parser.add_argument("--difficulty", type=str, default='2', help="difficulty of the scenario script")
    ...
    parser.add_argument("--learning_start_episode", type=int, default=1800, help="learning start episode")
    ...
    # checkpointing
    parser.add_argument("--fre4save_model", type=int, default=225)
    ...
    parser.add_argument("--old_model_name", type=str, default="models/1912_161657/", help="model are loaded")
